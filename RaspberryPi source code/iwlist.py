...
def get_frequency(cell):
	return matching_line(cell,"Frequency:").split("(")[0].split()[0]

def get_strength(cell):
	ret=matching_line(cell, "Quality=").split("=")[-1]
	return ret.split()[0]

def get_channel(cell):
    #print cell
    return matching_line(cell,"Frequency:").split(')')[0].split()[-1]
...
columns=["Name","Address","Quality","Channel","Strength","Frequency"]
